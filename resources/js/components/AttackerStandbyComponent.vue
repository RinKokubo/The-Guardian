<template>
  <div class="flex w-[100vw] h-[8vh] shadow-2xl">
    ...
    <div class="w-[85vw] bg-[#E76767] flex justify-center items-center">
      <h1 className="w-[100%] text-[3vh] font-bold ml-[40px] text-white">提供側カード選択</h1>
    </div>
  </div>
  <div class="bg-[#E5E5E5] w-[100vw] h-[92vh]">
    <ul class="flex flex-col gap-x-5 justify-center items-center gap-y-[2vh] py-[3vh]">
      <li v-for="(card) in defenderCards" :key="card.id">
        <div class="w-[90vw] h-[15vh] bg-blue-300 justify-start items-center px-[3vw] duration-500 shadow-2xl flex">
