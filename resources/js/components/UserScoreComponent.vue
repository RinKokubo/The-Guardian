<template>
  <div class="flex w-[100vw] h-[10vh] shadow-2xl">
    ...
    <div class="w-[85vw] bg-[#E76767] flex justify-center items-center">
      <h1 className="w-[100%] text-[4vh] font-bold ml-[40px] text-white">配点内訳</h1>
    </div>
  </div>
  <div class="bg-[#E5E5E5] w-[100vw] h-[90vh] flex flex-col items-center">
    <p class=" text-[2vh] font-bold">もしあなたが利用者カード<span class=" text-red-500">「{{ attackerCardName }}」</span>に対して、各提供カードに100点満点で点数をつけるとしたら？</p>
    <div class="flex">
      <div class="flex flex-col gap-x-5 justify-center items-center gap-y-[2vh] py-[3vh]">
        <div class="w-[60vw] h-[12vh] bg-blue-300 justify-start items-center pl-[5vw] duration-500 shadow-2xl flex">
          <img :src="`/img/${defenderCard1Name}.png`" alt="defender_card" class="w-[11vh] h-[11vh]">
          <p className="text-[2vh] font-bold pl-[5vw]">{{ defenderCard1Name }}</p>
        </div>
        <div class="w-[60vw] h-[12vh] bg-blue-300 justify-start items-center pl-[5vw] duration-500 shadow-2xl flex">
          <img :src="`/img/${defenderCard2Name}.png`" alt="defender_card" class="w-[11vh] h-[11vh]">
          <p className="text-[2vh] font-bold pl-[5vw]">{{ defenderCard2Name }}</p>
        </div>
        <div class="w-[60vw] h-[12vh] bg-blue-300 justify-start items-center pl-[5vw] duration-500 shadow-2xl flex">
          <img :src="`/img/${defenderCard3Name}.png`" alt="defender_card" class="w-[11vh] h-[11vh]">
          <p className="text-[2vh] font-bold pl-[5vw]">{{ defenderCard3Name }}</p>
        </div>
        <div class="w-[60vw] h-[12vh] bg-blue-300 justify-start items-center pl-[5vw] duration-500 shadow-2xl flex">
          <img :src="`/img/${defenderCard4Name}.png`" alt="defender_card" class="w-[11vh] h-[11vh]">
          <p className="text-[2vh] font-bold pl-[5vw]">{{ defenderCard4Name }}</p>
        </div>
        <div class="w-[60vw] h-[12vh] bg-blue-300 justify-start items-center pl-[5vw] duration-500 shadow-2xl flex">
          <img :src="`/img/${defenderCard5Name}.png`" alt="defender_card" class="w-[11vh] h-[11vh]">
          <p className="text-[2vh] font-bold pl-[5vw]">{{ defenderCard5Name }}</p>
        </div>
      </div>
      <div class="flex flex-col justify-center items-center gap-y-[2vh] py-[3vh] text-[2vh]">
      ...
      <form class="flex flex-col justify-center items-center gap-y-[2vh] py-[3vh] text-[2vh]">
